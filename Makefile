...
HEADERS = $(addprefix include/, ast.h ast_add.h ast_alloc.h ast_api.h ast_errors.h \
	ast_parse.h block_api.h error.h errors.h execution.h get_next_line.h hist.h \
	minishell.h minishell_types.h redirect_tab_utils.h searchdir.h terminal.h to_block.h)
...
$(OBJS):	$(HEADERS)	| $(SUBDIRS_OBJ)
$(OBJS_DB):	$(HEADERS)	| $(SUBDIRS_OBJ)
